...
export const sendPayment            = (sender_account, sender_priv, receiver_account, amount, request_id, memo)  => transferMoney(sender_account, sender_priv, receiver_account, amount, ('pay|'+request_id + '|' + memo)); 
